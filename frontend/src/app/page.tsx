          ...
          <dl className='search-terms'>
            ...
            <dd>
              ...
              <ul className='terms-list'>
                <li>
                  <Link href="" className='search-link'>검색 1</Link>
                  <button type='button' className='btn-del'>
                    <IoIosClose size={18}/>
                  </button>
                </li>
                <li>
                  <Link href="" className='search-link'>검색 2</Link>
                  <button type='button' className='btn-del'>
                    <IoIosClose size={18} />
                  </button>
                </li>
                <li>
                  <Link href="" className='search-link'>검색 3</Link>
                  <button type='button' className='btn-del'>
                    <IoIosClose size={18} />
                  </button>
                </li>
                <li>
                  <Link href="" className='search-link'>검색 4</Link>
                  <button type='button' className='btn-del'>
                    <IoIosClose size={18} />
                  </button>
                </li>
                <li>
                  <Link href="" className='search-link'>검색 5</Link>
                  <button type='button' className='btn-del'>
                    <IoIosClose size={18} />
                  </button>
                </li>
            ...
            <dd>
              ...
              <ul className='terms-list'>
                <li>
                  ...
                  <Link href="" className='follow-link'>김아무개111111</Link>
                </li>
                <li>
                  <button type='button' className='btn-del'>
                    <BsPersonCircle size={32} color="#dfdfdf" />
                  </button>
                  <Link href="" className='follow-link'>김아무개22222</Link>
                </li>
              </ul>
            </dd>
          </dl>
